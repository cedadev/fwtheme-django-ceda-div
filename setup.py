...
try:
    import fwtheme_django_ceda_div.__version__ as version
except ImportError:
    # If we get an import error, find the version string manually
    version = "unknown"
    with open(os.path.join(here, 'fwtheme_django_ceda_div', '__init__.py')) as f:
        for line in f:
...
if __name__ == "__main__":
    ...
    setup(
        ...
        url = 'https://github.com/cedadev/fwtheme-django-ceda-div',
